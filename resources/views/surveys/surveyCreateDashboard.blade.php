            ...
            <div class="col-xs-12 fix-pad" >
                <div class="radio-survey">
                    ...
                    <ul class="ul-radio-rate">
                        ...
                        <li>
                            <label style="{{($connected == 4 && $connectedID != 4) ? 'cursor: not-allowed;' : ''}}" > <input type="radio" name="connected" idConnection="{{$connectedID}}" {{($connected == $connectedID) ? 'checked="checked"' : ''}} class="show-box3 survey-question connection"  value="{{$connectedID}}" {{($connected == 4 && $connectedID != 4) ? 'disabled' : ''}}><span class="verticle-radio">{{trans('connected'.'.'.$connectedKey)}}</span></label>
                        </li>
                        @endforeach
                    </ul>
                </div>
